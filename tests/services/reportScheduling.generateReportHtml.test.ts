...
describe("ReportSchedulingService.generateReportHtml", () => {
  ...
  beforeEach(() => {
    ...
    getDriftSummariesMock.mockResolvedValue({ summaries: [], generatedAt: "", filters: {}, totals: {}, availableFilters: {} });
  });
  ...
  describe("reconciliation section", () => {
    it("renders drift data when available", async () => {
      getDriftSummariesMock.mockResolvedValue({ summaries: makeDrifts(), generatedAt: "", filters: {}, totals: {}, availableFilters: {} });
